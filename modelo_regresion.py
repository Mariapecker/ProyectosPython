...
df = pd.read_csv('https://drive.google.com/uc?export=download&id=10gsviaZaykZ4D7fwKHERsmVW6Tygqkav') # Datos pisos
df_distritos = pd.read_csv('https://drive.google.com/uc?export=download&id=10k2nNfvGUm6do9QMgtR4sd_Q4LGsd1_U') # Nombres e ids de distrito
